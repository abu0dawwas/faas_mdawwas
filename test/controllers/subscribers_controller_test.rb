...
class SubscribersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create subscriber" do
    assert_difference('Subscriber.count') do
      post subscribers_url, params: { subscriber: { name: @subscriber.name, subscribtion_date: @subscriber.subscribtion_date } }
    end
  ...
  test "should update subscriber" do
    patch subscriber_url(@subscriber), params: { subscriber: { name: @subscriber.name, subscribtion_date: @subscriber.subscribtion_date } }
